    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_organisor', models.BooleanField(default=False, verbose_name='Agency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('designation', models.CharField(choices=[('ceo', 'MD/CEO'), ('business_consultant', 'Business Consultant'), ('it_consultant', 'IT Consultant'), ('legal_consultant', 'Legal Consultant')], max_length=20)),
                ('words', models.CharField(max_length=100)),
                ('picture', models.ImageField(help_text='Width: 430px, Height: 450px', upload_to='pictures/team/', validators=[listings.validators.validate_picture_size])),
